import { motion } from 'framer-motion'; // External library imports should be first
import React from 'react'; // React import should also come first
import Link from 'next/link';
import { inter } from '../fonts/inter'; // Local imports should come after external imports
            ...
            <div className="mx-auto flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
                ...
                <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
                    <div className="flex w-[350px] max-w-[90%] flex-col items-end text-right text-[14px] font-semibold uppercase text-[#e4ded7] sm:w-[350px] sm:text-[14px] md:w-[310px] md:items-start md:text-left md:text-[16px] lg:w-[420px] lg:text-[16px]">
                        ...
                        />
                        <Link
                            href="mailto:sayammonga.work@gmail.com?subject=Lets%20work%20together!&amp;body=Hello%2C%20I%20think%20we%20need%20you%20to%20work%20on%2Fcollaborate%20this%20particular%20product...%20Reach%20out%20as%20soon%20as%20you%20can.By%20eldoraui"
                            target="_blank"
                    ...
                    <div className="flex gap-10 text-[16px] font-bold text-[#e4ded7] sm:gap-14 sm:text-[24px] md:gap-10 md:text-[16px] lg:gap-20 lg:text-[28px]">
                        <Link href="https://github.com/sayam-monga" target="_blank" aria-label="View GitHub Profile">
                            <AnimatedTitle
                                text={'GITHUB'}
                        ...
                        <Link
                            href="https://in.linkedin.com/in/sayam-monga-362634240"
                            target="_blank"
